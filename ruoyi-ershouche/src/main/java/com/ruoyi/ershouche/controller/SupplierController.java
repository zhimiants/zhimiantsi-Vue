 ...
 */
@RestController
@RequestMapping("/ershouche/supplier")
public class SupplierController extends BaseController
{
     ...
     * 查询卖家信息管理列表
     */
    @PreAuthorize("@ss.hasPermi('ershouche:supplier:list')")
    @GetMapping("/list")
     ...
     * 导出卖家信息管理列表
     */
    @PreAuthorize("@ss.hasPermi('ershouche:supplier:export')")
     ...
     * 获取卖家信息管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('ershouche:supplier:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增卖家信息管理
     */
    @PreAuthorize("@ss.hasPermi('ershouche:supplier:add')")
     ...
     * 修改卖家信息管理
     */
    @PreAuthorize("@ss.hasPermi('ershouche:supplier:edit')")
     ...
     * 删除卖家信息管理
     */
    @PreAuthorize("@ss.hasPermi('ershouche:supplier:remove')")
